...
func TestParseOctets(t *testing.T) {
	for i, spec := range []test[ip, bs]{
		...
		{ip{6, +1, ":1"}, ve[bs]{v: bs{0x00, 0x01}}},
		{ip{6, -1, "1:1"}, ve[bs]{v: bs{0x00, 0x01, 0x10}}},
		{ip{6, +1, "1:1"}, ve[bs]{v: bs{0x01, 0x00, 0x01}}},
		{ip{6, -1, "1:1:"}, ve[bs]{v: bs{0x00, 0x01, 0x00, 0x01}}},
		{ip{6, +1, ":1:1"}, ve[bs]{v: bs{0x00, 0x01, 0x00, 0x01}}},
		{ip{6, -1, "12:12"}, ve[bs]{v: bs{0x00, 0x12, 0x12}}},
		{ip{6, +1, "12:12"}, ve[bs]{v: bs{0x12, 0x00, 0x12}}},
		{ip{6, -1, "12:12:"}, ve[bs]{v: bs{0x00, 0x12, 0x00, 0x12}}},
		{ip{6, +1, ":12:12"}, ve[bs]{v: bs{0x00, 0x12, 0x00, 0x12}}},
		{ip{6, -1, "123:123"}, ve[bs]{v: bs{0x01, 0x23, 0x12, 0x30}}},
		{ip{6, +1, "123:123"}, ve[bs]{v: bs{0x01, 0x23, 0x01, 0x23}}},
		{ip{6, -1, "123:123:"}, ve[bs]{v: bs{0x01, 0x23, 0x01, 0x23}}},
		{ip{6, +1, ":123:123"}, ve[bs]{v: bs{0x01, 0x23, 0x01, 0x23}}},
		{ip{6, -1, "1234:1234"}, ve[bs]{v: bs{0x12, 0x34, 0x12, 0x34}}},
		{ip{6, +1, "1234:1234"}, ve[bs]{v: bs{0x12, 0x34, 0x12, 0x34}}},
		{ip{6, -1, "1234:1234:"}, ve[bs]{v: bs{0x12, 0x34, 0x12, 0x34}}},
		{ip{6, +1, ":1234:1234"}, ve[bs]{v: bs{0x12, 0x34, 0x12, 0x34}}},
		// invalid
