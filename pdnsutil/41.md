...
add-zone-key ZONE {zsk|ksk} [BITS] [active|inactive]
             [rsasha1|rsasha256|rsasha512|gost|ecdsa256|ecdsa384|ed25519]
...
change-slave-zone-master ZONE master-ip [master-ip..]
                                   Change slave zone ZONE master IP address to master-ip
